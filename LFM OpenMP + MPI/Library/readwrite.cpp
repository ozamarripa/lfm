...
int read_File(bool weighted, bool value_def, const string &file_name, const string &file_name2, int rank_processor) {	
	...
	ofstream netout(archivepath.c_str());
...
int read_File(bool weighted, const string &s) {
	...
	return read_File(weighted, false, s, s,0);
}


int read_File(const string &s) {
	
	return read_File(false, false, s, s,0);
}


int read_File(const string &s, const string &s2) {

	return read_File(false, true, s, s2,0);
}


int read_File(bool weighted, const string &s, const string &s2) {

	return read_File(weighted, true, s, s2,0);
}
